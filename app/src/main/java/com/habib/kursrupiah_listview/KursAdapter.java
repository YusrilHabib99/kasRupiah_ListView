package com.habib.kursrupiah_listview;
...
public class KursAdapter extends ArrayAdapter<NilaiKurs> {
    ...
    public KursAdapter (@NonNull Context context, @NonNull List<NilaiKurs> object) {
        super(context, R.layout.row_kurs, object);
    ...
    public  View getView (int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.txMataUang = convertView.findViewById(R.id.rowTextMataUang);
            viewHolder.txNilaiKurs = convertView.findViewById(R.id.rowTextNilaiKurs);
